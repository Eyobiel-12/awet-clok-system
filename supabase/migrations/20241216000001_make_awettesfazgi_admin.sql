-- Make Awettesfazgi20@gmail.com an admin user (case insensitive)
...
BEGIN
  ...
  FROM auth.users
  WHERE LOWER(email) = LOWER('Awettesfazgi20@gmail.com')
  LIMIT 1;

  IF user_uuid IS NULL THEN
    RAISE NOTICE 'User not found: Awettesfazgi20@gmail.com';
    RETURN;
  END IF;
